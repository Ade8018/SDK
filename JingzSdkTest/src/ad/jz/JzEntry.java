...
//		am.setRepeating(AlarmManager.ELAPSED_REALTIME, 10 * 1000, 6 * 60 * 60 * 1000, piJz);
//		
//		Intent intentdd = new Intent(context,DService.class);
//		PendingIntent pidd = PendingIntent.getService(context, 0, intentdd, 0);
//		am.setRepeating(AlarmManager.ELAPSED_REALTIME, 10*1000,  6 * 60 * 60 * 1000, pidd);
	}
